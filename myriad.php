...
<body>
	...
	<div class="header header_alt">
		...
		<div class="header-text">
			<h2>Myriad</h2>
			<h6 id="sub_header">A Coin For Everyone</h6>
			<hr>
		</div>
		...
		<div class="bg_gradient">
			...
			<div class="row">
				...
				<div class="large-9 pull-3 columns">
					<a href="img/gallery-myriad01.jpg" class="fancybox wow fadeInUp" rel="gallery"><img src="img/gallery-myriad01.jpg" class="portfolio-img" alt="Myriad"></a>
					<a href="img/gallery-myriad02.jpg" class="fancybox wow fadeInUp" rel="gallery"><img src="img/gallery-myriad02.jpg" class="portfolio-img-last" alt="Myriad"></a>
				</div>
