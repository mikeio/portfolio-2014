...
<body>
	...
	<div class="header">
		...
		<div class="header-text">
			<h6 id="intro">The Online Portfolio,&nbsp;of</h6>
			<h1>Mike Peters</h1>
			<h6 id="outro">A designer from Atlanta,&nbsp;Ga</h6>
			<hr>
		</div>
		...
		<div class="bg_white">
			...
			<div class="row">
				...
				<div class="large-4 columns">
					...
					<h4>Branding</h4>
					<p>Make your customers feel confident about the way they look at your products and services.</p>
				</div>
	
  				<div class="large-4 columns icon_middle">
  					<span class="icon_print"></span>
					<h4>Print Design</h4>
					<p>From stationery to packaging, design can sometimes make the best impression in print form.</p>
  				</div>
	
  				<div class="large-4 columns">
  					<span class="icon_web"></span>
					<h4>Web Design</h4>
					<p>I design and develop responsive and easy to use websites that are hand coded with HTML5 and CSS3. </p>
  				</div>
